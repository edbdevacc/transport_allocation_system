...
$sql = "SELECT transport.*,employees.name FROM transport JOIN employees ON transport.request_user = employees.id WHERE hr_approval=1 ORDER BY transport.id DESC";
